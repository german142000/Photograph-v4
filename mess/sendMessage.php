...
<script>
window.parent.postMessage("smifFrameLoad");
...
htrq.onload = function() {
	...
	htrqr.open('GET', apiServer + '/api/sendMessage.php?1=<?php echo $_GET["1"]?>&2=<?php echo $_GET["2"]?>' +
			  '&3=' + SSresult + '&4=' + STresult + '&5=' + UIresult + '&6=' + NKresult +
			  '&7=' + TSresult + '&8=' + TRresult + '&9=' + prime + '&10=' + mix.toString() + 
			  '&11=' + JSON.stringify(iv) + '&12=<?php echo $_GET["12"]?>&13=<?php echo $_GET["13"]?>' +
			  '&14=<?php echo $_GET["14"]?>&15=<?php echo $_GET["15"]?>', true);
	htrqr.send();
